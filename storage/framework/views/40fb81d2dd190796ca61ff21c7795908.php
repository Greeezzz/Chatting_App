    ...
    <div class="flex justify-center items-center h-screen">
        <div class="bg-gray-800 rounded-2xl p-8 shadow-2xl transition-transform transform hover:scale-105 w-full max-w-md border border-gray-700">
            ...
            <div class="flex justify-center space-x-4 mb-8">
                <a href="<?php echo e(route('login')); ?>" class="bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-6 rounded-full transition duration-300">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="bg-gray-700 hover:bg-gray-600 text-white font-semibold py-2 px-6 rounded-full transition duration-300">Register</a>
            </div>
...
<?php /**PATH C:\laragon\www\wheahchelodewi\resources\views/welcome.blade.php ENDPATH**/ ?>